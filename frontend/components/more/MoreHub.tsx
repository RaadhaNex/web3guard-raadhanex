...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      ["Deep scan orchestrator", "/deep-scan-orchestrator", "Phase 78: Quick Scan default, Deep Scan optional evidence, Expert Evidence artifacts, and clear run/skip states."],
