...
const moreGroups: MoreGroup[] = [
  ...
  },
  {
    ...
    helper: "Simple public pages that explain Web3Guard safely.",
    items: [
      {
        href: "/docs",
        label: "Docs",
      ...
      },
      {
        href: "/methodology",
        label: "Methodology",
        description: "Understand scoring, severity, evidence, and missing coverage states.",
        icon: "docs",
        status: "core",
      },
      {
  ...
  },
  {
    ...
    helper: "Public scanner entry points only. Admin/Ops tools are separate.",
    items: [
      {
        href: "/scanner/unified-url",
        label: "Unified scanner",
        description: "Run website, contract, GitHub, API, wallet, and admin-readiness evidence in one flow.",
        icon: "scan",
        status: "core",
        activePrefixes: ["/scanner/unified-url"],
      },
      {
        href: "/scanner/website",
        label: "Website scan",
        description: "HTTPS, headers, public paths, cookies, and frontend launch surface.",
        icon: "scan",
        status: "beta",
      },
      {
        ...
        label: "Contract scan",
        description: "Solidity evidence, verified source, static-analysis readiness, and rule signals.",
        icon: "advanced",
        status: "beta",
      },
      {
        href: "/scanner/github",
        label: "GitHub scan",
        description: "Repo hygiene, dependency risk, Solidity files, CI, and exposure signals.",
        icon: "saved",
        status: "beta",
      },
      {
        ...
        label: "API review",
        description: "Auth, CORS, webhook, rate-limit, and admin exposure evidence.",
        icon: "risk",
        status: "beta",
      },
      {
        href: "/scanner/wallet",
        label: "Wallet UX",
        description: "Wallet-connect and transaction-flow safety review.",
        icon: "payment",
        status: "beta",
      },
    ],
  },
  {
    ...
    helper: "Commercial and support pages for public users.",
    items: [
      {
        href: "/pricing",
        label: "Pricing",
        description: "Free scan, pilot report, and custom support paths.",
        icon: "price",
        status: "core",
      },
      {
        ...
        description: "UPI/manual payment validation for the pilot report path.",
        icon: "payment",
        status: "setup",
      },
      {
        href: "/contact",
        label: "Contact",
        description: "Request manual review scope, provider setup, or launch support.",
        icon: "docs",
        status: "core",
      },
      {
        href: "/more",
        label: "More hub",
        description: "All public user screens grouped without admin clutter.",
        icon: "more",
        status: "core",
        activePrefixes: ["/more"],
      },
