  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="quantum-stage p-6 sm:p-8">
        <p className="section-label">Real provider live integration</p>
        ...
        <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-400 sm:text-base">
          The provider truth layer connects for explorer verified source, GitHub metadata, GoPlus readiness, and advisory sources. Missing keys or disabled sources remain visible as Needs API Key / Provider Not Configured / Not Assessed.
        </p>
      </section>
      <ProviderLiveClient />
    </main>
