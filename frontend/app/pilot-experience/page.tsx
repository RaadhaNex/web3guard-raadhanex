...
export const metadata = {
  ...
  description: "Pilot experience pilot user experience polish, status copy, feedback intake, and safe claim checks.",
};
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <section className="quantum-stage p-6 sm:p-8">
        <p className="section-label">Pilot experience</p>
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-400 sm:text-base">
          Pilot experience keeps the public journey simple, hides advanced pages from first-time users, improves setup-state wording, and collects pilot feedback without private keys or fake claims.
        </p>
