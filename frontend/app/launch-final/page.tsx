  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="quantum-stage p-6 sm:p-8">
        <p className="section-label">Launch final QA + public release</p>
        ...
        <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-400 sm:text-base">
          The launch command center gives RAADHANEX a safe release workflow: release gates, production checklist, deploy verification, safe release notes, and blocked wording checks before public beta traffic.
        </p>
      </section>
      <LaunchFinalClient />
    </main>
