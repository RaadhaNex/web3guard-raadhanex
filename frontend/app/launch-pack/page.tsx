...
export const metadata = {
  ...
  description: "Phase 36 MVP launch pack, first 10 users tracker, honest outreach kit, public beta checklist, and safe claim guardrails.",
};
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <section className="quantum-stage p-6 sm:p-8">
        <p className="section-label">Phase 36</p>
