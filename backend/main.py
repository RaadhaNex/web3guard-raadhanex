...
app.include_router(pilot_experience.router)
app.include_router(mvp_launch.router)
app.include_router(scanner_depth.router)
app.include_router(risk_intelligence.router)
app.include_router(web_dast.router)
app.include_router(admin_pentest.router)
app.include_router(openzeppelin_pattern.router)
app.include_router(scanner_correlation.router)
app.include_router(scanner_truth_validation.router)
app.include_router(real_findings_pipeline.router)
...
app.include_router(detection_expansion.router)
app.include_router(deep_evidence_accuracy.router)
app.include_router(deep_scan_orchestrator.router)
app.include_router(contract_benchmark.router)
app.include_router(formal_fuzz_artifacts.router)
app.include_router(public_proof_report.router)
app.include_router(review_ops.router)
app.include_router(professional_accuracy.router)
app.include_router(professional_benchmark_g.router)
app.include_router(professional_rule_tuning_h.router)
app.include_router(professional_external_validation_i.router)
app.include_router(professional_monitoring_j.router)
