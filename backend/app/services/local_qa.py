...
ESSENTIAL_BACKEND_ENDPOINTS = [
    ...
    {"method": "GET", "path": "/qa/status", "purpose": "Phase 6 local QA status"},
    {"method": "GET", "path": "/launch/pack", "purpose": "Phase 6.2 deploy and launch pack"},
    {"method": "GET", "path": "/db/status", "purpose": "Phase 7 database/Supabase readiness status"},
    {"method": "GET", "path": "/dashboard/overview", "purpose": "Phase 7 user dashboard overview"},
    {"method": "GET", "path": "/workspace/status", "purpose": "Phase 7.2 organization/team workspace status"},
    {"method": "GET", "path": "/securescore/status", "purpose": "Phase 10 SecureScore Pro readiness status"},
    {"method": "GET", "path": "/securescore/overview", "purpose": "Phase 10 SecureScore dashboard overview from saved scans"},
    {"method": "GET", "path": "/findings", "purpose": "Phase 10 saved finding list with workflow statuses"},
    {"method": "POST", "path": "/organizations", "purpose": "Phase 7.2 create organization workspace"},
    {"method": "GET", "path": "/organizations", "purpose": "Phase 7.2 list user organizations"},
    {"method": "GET", "path": "/organizations/{organization_id}", "purpose": "Phase 7.2 workspace overview"},
    {"method": "POST", "path": "/organizations/{organization_id}/members", "purpose": "Phase 7.2 save manual member invite record"},
    {"method": "POST", "path": "/workspace/finding-tasks", "purpose": "Phase 7.2 create finding remediation task"},
    {"method": "POST", "path": "/workspace/comments", "purpose": "Phase 7.2 add workspace comment"},
    {"method": "POST", "path": "/profile", "purpose": "Phase 7 profile upsert"},
    {"method": "POST", "path": "/projects", "purpose": "Phase 7 project persistence"},
    {"method": "GET", "path": "/projects/{project_id}", "purpose": "Phase 7.1 project detail with scans/reports/activity"},
    {"method": "PATCH", "path": "/projects/{project_id}", "purpose": "Phase 7.1 project notes/status update"},
    {"method": "POST", "path": "/scan-history", "purpose": "Phase 7 scan history persistence"},
    {"method": "GET", "path": "/scan-history/{scan_id}", "purpose": "Phase 7.1 scan detail payload view"},
    {"method": "PATCH", "path": "/scan-history/{scan_id}", "purpose": "Phase 7.1 scan workflow status update"},
    {"method": "POST", "path": "/saved-reports", "purpose": "Phase 7 saved report persistence"},
    {"method": "GET", "path": "/saved-reports/{saved_report_id}", "purpose": "Phase 7.1 saved report detail"},
    {"method": "PATCH", "path": "/saved-reports/{saved_report_id}", "purpose": "Phase 7.1 report visibility/status update"},
    {"method": "GET", "path": "/packages", "purpose": "Pricing/package list"},
    {"method": "POST", "path": "/payment-intent", "purpose": "Phase 8 Razorpay/UPI payment intent"},
    {"method": "GET", "path": "/payments/status", "purpose": "Phase 8 payment gateway readiness status"},
    ...
    {"method": "GET", "path": "/scan/github/status", "purpose": "Phase 11 GitHub repo scanner status"},
    {"method": "GET", "path": "/scan/contract-address/status", "purpose": "Phase 12 verified contract address scanner status"},
    {"method": "GET", "path": "/scan/permission-map/status", "purpose": "Phase 16 permission map and centralization scanner status"},
    {"method": "GET", "path": "/scan/static-analysis/status", "purpose": "Phase 13 Slither/Aderyn/Semgrep real tool status"},
    {"method": "POST", "path": "/scan/github-repo", "purpose": "Phase 11 public GitHub repository scanner"},
    {"method": "POST", "path": "/scan/contract", "purpose": "Solidity rule-engine scan"},
    {"method": "POST", "path": "/scan/static-analysis", "purpose": "Phase 13 real static-analysis tool runner"},
    {"method": "POST", "path": "/scan/permission-map", "purpose": "Phase 16 permission map and founder transparency report"},
    ...
    {"method": "POST", "path": "/report/professional", "purpose": "Phase 9 combined report plus delivery artifacts"},
    {"method": "POST", "path": "/report/export/pdf", "purpose": "Phase 9 server-side PDF report export"},
    {"method": "POST", "path": "/report/publication", "purpose": "Phase 9 public/private report record"},
    {"method": "GET", "path": "/report/delivery-policy", "purpose": "Phase 9 report delivery policy"},
    ...
    {"method": "GET", "path": "/cicd/status", "purpose": "Mega Phase E CI/CD template status"},
    {"method": "POST", "path": "/cicd/template", "purpose": "Mega Phase E generate GitHub Action/Web3Guard CI templates"},
    {"method": "POST", "path": "/cicd/validate", "purpose": "Mega Phase E validate CI config text without executing workflow"},
    {"method": "GET", "path": "/learning/status", "purpose": "Mega Phase E Learning Center status"},
    {"method": "GET", "path": "/learning/lessons", "purpose": "Mega Phase E list Hinglish/English security lessons"},
    {"method": "POST", "path": "/learning/progress", "purpose": "Mega Phase E save real user lesson progress"},
    {"method": "GET", "path": "/admin/super/dashboard", "purpose": "Mega Phase E admin super dashboard; requires ADMIN_TOKEN"},
    {"method": "GET", "path": "/admin/super/system-health", "purpose": "Mega Phase E admin storage/provider health snapshot; requires ADMIN_TOKEN"},
    ...
    {"method": "GET", "path": "/security-hardening/status", "purpose": "Mega Phase G platform security hardening status"},
    {"method": "GET", "path": "/security-hardening/headers-preview", "purpose": "Mega Phase G security headers preview"},
    {"method": "GET", "path": "/production-qa/status", "purpose": "Mega Phase G final production QA status"},
    {"method": "GET", "path": "/production-qa/final-checklist", "purpose": "Mega Phase G final launch checklist"},
    {"method": "GET", "path": "/production-qa/account-setup", "purpose": "Mega Phase G manual account/env setup matrix"},
]
